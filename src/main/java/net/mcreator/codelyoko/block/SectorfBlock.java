...
public class SectorfBlock extends CodeLyokoModElements.ModElement {
	@ObjectHolder("code_lyoko:sectorf")
	public static final Block block = null;
	public SectorfBlock(CodeLyokoModElements instance) {
		super(instance, 1);
	}

...
import net.mcreator.codelyoko.procedures.TinterOnBlockRightClickedProcedure;
...
public class TinterBlock extends CodeLyokoModElements.ModElement {
	@ObjectHolder("code_lyoko:tinter")
	public static final Block block = null;
	public TinterBlock(CodeLyokoModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				TinterOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}

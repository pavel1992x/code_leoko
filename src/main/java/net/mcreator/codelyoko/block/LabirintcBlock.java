...
public class LabirintcBlock extends CodeLyokoModElements.ModElement {
	@ObjectHolder("code_lyoko:labirintc")
	public static final Block block = null;
	public LabirintcBlock(CodeLyokoModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).lightValue(8));
			setRegistryName("labirintc");
		}

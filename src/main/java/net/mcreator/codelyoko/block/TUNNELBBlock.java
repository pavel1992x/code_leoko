...
public class TUNNELBBlock extends CodeLyokoModElements.ModElement {
	@ObjectHolder("code_lyoko:tunnelb")
	public static final Block block = null;
	public TUNNELBBlock(CodeLyokoModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f).lightValue(15));
			setRegistryName("tunnelb");
		}

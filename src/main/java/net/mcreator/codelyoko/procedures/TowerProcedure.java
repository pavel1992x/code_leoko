...
public class TowerProcedure extends CodeLyokoModElements.ModElement {
	public TowerProcedure(CodeLyokoModElements instance) {
		super(instance, 5);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Tower!");
			return;
		}

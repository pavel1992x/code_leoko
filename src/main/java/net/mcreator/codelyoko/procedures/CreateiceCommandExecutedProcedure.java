...
public class CreateiceCommandExecutedProcedure extends CodeLyokoModElements.ModElement {
	public CreateiceCommandExecutedProcedure(CodeLyokoModElements instance) {
		super(instance, 12);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure CreateiceCommandExecuted!");
			return;
		}
